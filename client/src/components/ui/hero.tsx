...
import { ArrowRight, Leaf, Award, CheckCircle2 } from "lucide-react";

export default function Hero() {
  return (
    <div>
      {/* Main Hero Section - IFDC inspired */}
      <section className="relative bg-gradient-to-r from-primary/95 to-primary">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pr-12 mb-8 md:mb-0 text-white">
              <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl mb-4 leading-tight">
                Kenya's Finest <span className="text-accent">Tree Nursery</span>
              </h1>
      ...
      {/* Quick info section - IFDC inspired */}
      <section className="bg-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center p-4 rounded-md border border-muted">
